...
1. Create virtualenv using uv and activate it
1. Run `uv sync` to install dependencies
1. Install pre-commit for this repository by running `pre-commit install` and `pre-commit install --hook-type commit-msg`
